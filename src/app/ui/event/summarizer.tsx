            ...
            <div className="grid grid-cols-2 md:grid-cols-3 w-full h-full p-4 md:divide-x md:divide-gray-500/50">
                <div className="flex items-center justify-center">
                    <div className="flex flex-col items-start justify-center">
                        ...
                        <h1 className={`${rethinkSans.className} antialiased font-extrabold text-5xl 2xl:text-6xl -mt-1`} style={{ color: '#006400' }}>{bestPick.teamNumber ? bestPick.teamNumber : "—"}</h1>
                    </div>
                </div>
                ...
                <div className="hidden md:flex items-center justify-center">
                    <div className="flex flex-col items-start justify-center">
                        ...
                        <h1 className={`${rethinkSans.className} antialiased font-extrabold text-5xl 2xl:text-6xl -mt-1`} style={{ color: '#006400' }}>{bestCoralBot ? bestCoralBot : "—"}</h1>
                    </div>
                </div>
                <div className="hidden md:flex items-center justify-center">
                    <div className="flex flex-col items-start justify-center">
                        <h1 className={`${rethinkSans.className} antialiased font-extrabold text-lg xl:text-2xl`}>best algae bot</h1>
                        <h1 className={`${rethinkSans.className} antialiased font-extrabold text-5xl 2xl:text-6xl -mt-1`} style={{ color: '#006400' }}>{bestAlgaeBot ? bestAlgaeBot : "—"}</h1>
                    </div>
                </div>
            </div>
